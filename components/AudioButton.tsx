...
const AudioButton: React.FC<AudioButtonProps> = ({ text, className = "", size = 'md' }) => {
  ...
  return (
    <button
      onClick={handlePlay}
      disabled={isPlaying}
      className={`flex items-center justify-center rounded-full bg-blue-100 text-blue-600 hover:bg-blue-200 transition-colors p-2 disabled:opacity-50 ${className}`}
